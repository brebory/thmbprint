...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProjectItem.attached_file_extension'
        db.add_column(u'profiles_projectitem', 'attached_file_extension',
                      self.gf('django.db.models.fields.CharField')(default='jpg', max_length=4),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProjectItem.attached_file_extension'
        db.delete_column(u'profiles_projectitem', 'attached_file_extension')
