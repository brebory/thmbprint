...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ProjectItem.attached_file'
        db.add_column(u'profiles_projectitem', 'attached_file',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'ProjectItem.attached_file'
        db.delete_column(u'profiles_projectitem', 'attached_file')
