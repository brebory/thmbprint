...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'profiles_project', 'created_at',
        ...
        db.add_column(u'profiles_project', 'updated_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2014, 5, 14, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.created_at'
        db.delete_column(u'profiles_project', 'created_at')

        # Deleting field 'Project.updated_at'
        db.delete_column(u'profiles_project', 'updated_at')
    ...
    models = {
        ...
        u'profiles.projectitem': {
            ...
            'attached_file_extension': ('django.db.models.fields.CharField', [], {'max_length': '4'}),
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
