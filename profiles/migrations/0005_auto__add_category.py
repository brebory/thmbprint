...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        m2m_table_name = db.shorten_name(u'profiles_project_categories')
    ...
    def backwards(self, orm):
        ...
        db.delete_table(db.shorten_name(u'profiles_project_categories'))
    ...
    models = {
        ...
        u'profiles.projectitem': {
            ...
            'attached_file_extension': ('django.db.models.fields.CharField', [], {'max_length': '4', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
